...
def get_profile_data():
    employee = _employee_for_user()
    fields = ["name", "employee_name", "first_name", "middle_name", "last_name", "gender", "date_of_birth", "company", "department", "designation", "branch", "grade", "reports_to", "date_of_joining", "employment_type", "holiday_list", "cell_number", "personal_email", "company_email", "prefered_contact_email", "image"]
