const CACHE="employee-portal-v45";
const ASSETS=["/assets/hr_custom/js/mobile_attendance_app.js?v=47","/assets/hr_custom/js/attendance_session_guard.js?v=7","/assets/hr_custom/attendance-manifest.json?v=4","/assets/hr_custom/images/attendance-icon-192.png?v=3","/assets/hr_custom/images/attendance-icon-512.png?v=3","/assets/hr_custom/images/apple-touch-icon.png?v=3"];
try {
